...
public class TekkitDirtBlockListener implements Listener{
	
	private TekkitDirtBlockHolder stats;
	private TekkitDirtBlockConfig config;
	
	public TekkitDirtBlockListener(TekkitDirtBlockHolder stats, TekkitDirtBlockConfig config) {
		this.stats = stats;
		this.config = config;
	}
